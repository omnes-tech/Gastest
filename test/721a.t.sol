...
contract SolmateNftTests is Test {
    ...
    ContractA private nft;

    function setUp() public {
        // Deploy NFT contract
        nft = new ContractA("NFT_tutorial", "TUT", "baseUri");
    }

    function testFailNoMintPricePaid() public {
        nft.mintTo(address(1), 10);
    }

    function testMintPricePaid() public {
        nft.mintTo{value: 0.08 ether}(address(1), 10);
    }
    ...
    function testFailMintToZeroAddress() public {
        nft.mintTo{value: 0.08 ether}(address(0), 10);
    }
